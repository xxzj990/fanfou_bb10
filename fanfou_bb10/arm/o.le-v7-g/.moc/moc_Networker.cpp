...
const QMetaObjectExtraData NetWorker::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject NetWorker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_NetWorker,
      qt_meta_data_NetWorker, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &NetWorker::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NetWorker))
