...
#include "../../../src/fanfou/LoginThread.h"
...
static const char qt_meta_stringdata_LoginThread[] = {
    "LoginThread\0\0result\0done(QString)\0"
};
...
const QMetaObjectExtraData LoginThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject LoginThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_LoginThread,
      qt_meta_data_LoginThread, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &LoginThread::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LoginThread))
...
// SIGNAL 0
void LoginThread::done(QString _t1)
{
